package com.cloud.teambition.server;

import com.alibaba.fastjson.JSONObject;
import com.cloud.common.entity.ResponseMessage;
import com.cloud.common.enums.ResponseCodeEnum;
import com.cloud.common.utils.StringUtils;
import com.cloud.teambition.server.utils.RedisUtils;
...
@MapperScan({"com.cloud.teambition.server.mapper"})
@Slf4j
public class CloudTeambitionServerApplication implements WebMvcConfigurer {
    ...
    public static void main(String[] args) {
        SpringApplication.run(CloudTeambitionServerApplication.class, args);
        log.info("-------------------CloudTeambitionServerApplication 启动成功------------------------");
    }
